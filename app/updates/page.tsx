    ...
    <>
      ...
      <div className="info-card">
        ...
        <ul>
          ...
          <li>🎭 <b>模擬示範版</b>：未登入都可以試晒成個系統 — 登入頁／「🌏 使用地區」有「🎭 模擬示範版」入口（或直接開 <code>?demo=1</code> 連結），一鍵以助理區總監（ADC）身份示範（管理系統大部分都係 ADC 處理），示範版權限全開，咩功能都試到（成人獎勵提名唔喺示範範圍，正式系統先用到）。全部資料屬虛構示範、<b>只存喺你嘅瀏覽器</b>，絕對唔會寫入任何區方後台</li>
