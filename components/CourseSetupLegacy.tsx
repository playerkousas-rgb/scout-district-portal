'use client';
/**
 * 🛠 舊直入分頁（v4.14.0 後備）— 揀班／開新班／填設定／雙向同步／12 張列印。
 * v4.17.0 起新版流程（訓練班系統先行）做咗主線，呢個直入版收埋做後備——舊班同步／列印照用得。
 * 原版（CL 填 Sheet 舊制）喺「開班登記」分頁，原封不動。
 */
...
export default function CourseSetupLegacy({ session, links, reloadLinks, districtName, fpsAccount, memberPortalUrl, courseTemplateSet }: Props) {
