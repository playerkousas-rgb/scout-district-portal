 ...
 * ================================================================
 * 🚀 開班 5 步（每班 1 次，照住做就得）：
 *   1. 下載本模版（區管理平台「🎓 訓練班管理」頁有下載掣）。
 *   2. 為呢個訓練班開一張「空白」Google Sheet。
 *   3. 擴充功能 → Apps Script → 將本檔案整份貼上 → 儲存。
 *   4. 執行 setupCourseSheet()（首次授權：Review permissions → Advanced → Allow）。
 ...
 *   - 成員填表 → 主系統 submitCourseReg_ → 轉發嚟呢度 addReg_
